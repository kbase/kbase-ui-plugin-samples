...
import testField1Data from '../../../data/view.test.data.field1.json';
import testEmptyFieldData from '../../../data/view.test.data.emptyField.json';
import testEmptyNumberFieldData from '../../../data/view.test.data.sample.emptyNumberField.json';
import testEmptyOntologyTermFieldData from '../../../data/view.test.data.sample.emptyOntologyTermField.json';
import testOntologyTermFieldData from '../../../data/view.test.data.sample.ontologyTermField.json';
import testSampleData from '../../../data/view.test.data.sample.json';

import testNumericFieldData from '../../../data/view.test.data.numericField.json';
import testSample2Data from '../../../data/view.test.data.sample2.json';


import Component from "components/MetadataControlledField/view";
import {MetadataControlledField, Sample} from "../../../../lib/ViewModel/ViewModel";
